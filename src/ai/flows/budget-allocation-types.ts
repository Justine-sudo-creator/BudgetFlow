...
export const BudgetAllocationInputSchema = z.object({
    ...
    remainingBalance: z.number().describe("The actual amount of money left to be budgeted."),
...
export const BudgetAllocationOutputSchema = z.object({
    suggestion: z.string().describe("A markdown-formatted string with budget allocation suggestions for each category, including percentages and justifications. This plan should be a 'course-correction' based on the remaining balance.")
});
